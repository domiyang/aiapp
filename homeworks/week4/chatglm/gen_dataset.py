# python code to gen custom dataset for - peft qlora chatglm finetune and inference with custom dataset
# 第四周作业：
# 1、基于 data 目录下的数据训练 ChatGLM3 模型，使用 inference Notebook 对比微调前后的效果。
# 2、（可选）：将 gen_dataset Notebook 改写为 py 文件。------> this notebook is for this task.
# 作业代码：
...
# this runs only when the file execute directly
